  ...
  <div id="container">
      ...
      <form method="POST" action="sendmail.php">
          ...
          <div id="part-1">
            ...
            <input class="input-custom" type="email" name="email" placeholder="account@email.com" id="email" required>
            <br><br>
            <label for="message">Insira o conteúdo do e-mail</label><br>
            <textarea class="input-custom" name="body" rows="5" cols="50" id="body" tabindex="-1"></textarea>
            <br><br>
            <label>Insira os anexos do e-mail:</label>
            <input type="file" name="anexos">
          <br/><br/>
          <input type="submit" class="btn-custom" id="submitButton" name="Enviar" value="Enviar E-Mail">
        </div>
