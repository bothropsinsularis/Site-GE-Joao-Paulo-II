...
<div class="caixa">
    <form class="form-inline" action="busca.php" method="post">
      <input class="input-custom" id="busca" name="busca" type="text" value="<?php echo $_POST['busca'] ?>" placeholder="Pesquisar Tópico" aria-label="Pesquisar">
    </form>
  </div>
    </div>
    <div class="content">
  ...
  <tbody>
        ...
        $sql = "SELECT * FROM topico WHERE nome LIKE '%".$_POST['busca']."%'";
        $res = $conn -> query($sql);
