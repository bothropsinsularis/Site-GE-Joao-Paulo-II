...
?>
  ...
  <tbody>
        ...
        $sql = "SELECT * FROM compras WHERE userid=".$_SESSION['userid'];
        $res = $conn -> query($sql);
        for($i = 0; $i < $res ->num_rows; $i++){
            ...
            print "<tr><td>".$linha['id']."</a></td>";
            print "<td>".$linha['data']."</td>";
            print "<td>".$linha['estado']."</td>";
            print "<td><a href='gerar_pdf.php?id=".$linha['id']."'>Download</a></td>";
        }
        ?>
  </tbody>
</table>
