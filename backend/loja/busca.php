<?php
include_once '../classes/class_IRepositorioProdutos.php';
...
<body>
  ...
  <div class="caixa">
    <form class="form-inline" action="busca.php" method="post">
      <input class="input-custom" id="busca" name="busca" type="text" placeholder="Pesquisar Produto"
  ...
  <div class="conteudo">
    ...
    <div class="loja">
      ...
      <br>
      <a href="../carrinho/carrinho.php">Carrinho</a><br><br>
      <a href="../recibos/index.php">Compras Realizadas</a><br><br>

      <div class="d-flex justify-content-center align-itens-center row wrap gap-4 py-4">
        <?php
        $sql = "SELECT * FROM produtos WHERE nome LIKE '%".$_POST['busca']."%'";
        $res = $conn->query($sql);
        for ($i = 0; $i < $res->num_rows; $i++) {
          $linha = $res->fetch_assoc();
          print '      <div class="col-md-3">
                            <a href="produto.php?id=' . $linha['id'] . '">
                            <div class="product-card p-3 text-center">
                                <img src="../../frontend/public/imagens/produtos/' . $linha["foto"] . '" class="img-fluid product-image mb-3"
