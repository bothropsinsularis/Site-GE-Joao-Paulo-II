...
<nav class="navbar navbar-expand-lg py-3 custom-navbar">
    ...
    <fieldset>
            ...
            <input class="input-custom" type="text" name="title" placeholder="Nome" id="title" required value="<?= htmlspecialchars($image['nome']) ?>">
            <br><br>
            <label for="title">Descrição: (Insira como código de HTML)</label>
            <textarea required class="input-custom" name="desc" id="title"> <?= htmlspecialchars($image['descricao']) ?></textarea>
            <br><br>
            <label for="title">Estoque:</label>
            <input class="input-custom" type="text" name="qtd" placeholder="Quantidade no Estoque" id="title" required value="<?= htmlspecialchars($image['estoque']) ?>">
            <br><br>
            <label for="title">Preço:</label>
            <input class="input-custom" type="text" name="preco" placeholder="Preço" id="title" required value="<?= htmlspecialchars($image['preco']) ?>">
            <br><br>
