...
<section>
        <div class="container my-5">
            <h2 class="text-center mb-4">Painel de Controle dos Eventos</h2>
            <div class="table-responsive">
              ...
              for($i = 0; $i < $res ->num_rows; $i++){
                ...
                print '<tr>
                    ...
                    <td class="compra align-middle">'.$linha["event_date"].'</td>
                    <td class="align-middle">
                        <a href="edit_evento.php?id='.$linha["id"].'">
                        <button class="btn btn-warning btn-sm mx-1">
                            <i class="bi bi-pencil-square"></i>
                        </button>
                        </a>
                        <a href="delete_evento.php?id='.$linha["id"].'">
        ...
        <a class="btn" href="add_evento.php">Adicionar Novo Evento</a>
