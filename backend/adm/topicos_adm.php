...
<section>
        <div class="container my-5">
            <h2 class="text-center mb-4">Painel de Controle dos Tópicos</h2>
            <div class="table-responsive">
              ...
              for($i = 0; $i < $res ->num_rows; $i++){
                ...
                print '<tr>
                    <td class="align-middle"><a href="../../frontend/principal/user.php?id='.$user['id'].'">'.$user["nome"].'</a></td>
                    <td class="align-middle"><a href="../forum/topico.php?id='.$linha["id"].'">'.$linha["nome"].'</a></td>
                    <td class="align-middle">
                        <a href="delete_topico.php?id='.$linha["id"].'">
